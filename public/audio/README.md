...
Current batch:
- Generated on 2026-07-24 for #t24 / #t25, then extended on 2026-07-25 for #t27 material and practice prompts.
- Voice: `zh-CN-XiaoxiaoNeural`.
- Rate: `-8%`.
- Coverage: all current `DialogueLine.audio`, `SentencePattern.audio`, `VocabularyItem.audio`, `PronunciationTip.audio`, `PracticePrompt.audio`, and `ShortInputPrompt.audio` paths under `src/content/lessons/*.ts` (89 files after the #t27 practice-prompt extension).
