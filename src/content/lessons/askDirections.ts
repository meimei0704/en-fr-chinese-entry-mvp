  ...
  sentencePatterns: [
    {
      ...
      pattern: '师傅您好，我要去……。',
      meaning: { en: 'Hello, please go to ...', fr: 'Bonjour, conduisez-moi à ..., s\'il vous plaît.' },
      example: '师傅您好，我要去这里。',
    ...
    },
    {
      ...
      pattern: '请……。',
      meaning: { en: 'Please ... (polite request)', fr: 'S\'il vous plaît ... (demande polie)' },
      example: '请打表。',
    ...
    },
    {
      ...
      pattern: '可以……吗？',
      meaning: { en: 'Can I ...? / Could you please ...?', fr: 'Puis-je ... ? / Pourriez-vous ... ?' },
      example: '可以开空调吗?',
    ...
    },
    {
      ...
      pattern: '大概多久到？',
      meaning: { en: 'How long will it take?', fr: 'Combien de temps pour arriver ?' },
      example: '大概多久到？',
    ...
    },
    {
      ...
      pattern: '一共多少钱？',
      meaning: { en: 'How much is it altogether?', fr: 'Combien ça fait au total ?' },
      example: '一共多少钱？',
