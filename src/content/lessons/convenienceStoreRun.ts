  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        speaker: { en: 'Traveler', fr: 'Voyageur' },
        hanzi: '我用微信支付 / 支付宝。',
        pinyin: 'Wǒ yòng Wēixìn zhīfù / Zhīfùbǎo.',
  ...
  sentencePatterns: [
    {
      ...
      pattern: '……多少钱?',
      meaning: { en: 'How much is this?', fr: 'C\'est combien ?' },
      example: '这个多少钱?',
    ...
    },
    {
      ...
      pattern: '太……了。',
      meaning: { en: 'It\'s too ...', fr: 'C\'est trop ...' },
      example: '太贵了。',
    ...
    },
    {
      ...
      pattern: '可以……吗?',
      meaning: { en: 'Can you ...?', fr: 'Pouvez-vous ... ?' },
      example: '可以便宜一点吗?',
    ...
    },
    {
      ...
      pattern: '我用微信支付 / 支付宝。',
      meaning: { en: 'I will use WeChat Pay / Alipay.', fr: 'Je vais payer avec WeChat / Alipay.' },
      example: '我用微信支付 / 支付宝。',
