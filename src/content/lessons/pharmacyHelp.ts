...
export const pharmacyHelpLesson: LessonContent = {
  ...
  vocabulary: [
    ...
    { id: 'pharmacy-help-vocab-11', hanzi: '医院', pinyin: 'yī yuàn', audio: '/audio/pharmacy-help/vocab-11.mp3', meaning: { en: 'hospital', fr: 'hôpital' }, explanation: { en: 'The place where you see a doctor or go to a pharmacy.', fr: 'Le lieu où tu vois un médecin ou tu vas à la pharmacie.' } },
  ],
  practice: {
    listening: [
      {
