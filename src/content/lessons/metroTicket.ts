  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        speaker: { en: 'Traveler', fr: 'Voyageur' },
        hanzi: '我要去天安门广场。',
        pinyin: 'Wǒ yào qù Tiān\'ānmén Guǎngchǎng.',
      ...
      },
      {
        ...
        speaker: { en: 'Traveler', fr: 'Voyageur' },
        hanzi: '自动售票机怎么用？',
        pinyin: 'Zìdòng shòupiàojī zěnme yòng?',
      ...
      },
      {
        ...
        speaker: { en: 'Traveler', fr: 'Voyageur' },
        hanzi: '请问在哪儿换乘？',
        pinyin: 'Qǐngwèn zài nǎér huànchéng?',
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          hanzi: '共享单车怎么用？',
          pinyin: 'Gòngxiǎng dānchē zěnme yòng?',
          en: 'shared bike',
          fr: 'vélo partagé',
        },
      ],
