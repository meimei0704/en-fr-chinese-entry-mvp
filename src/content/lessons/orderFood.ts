...
export const orderFoodLesson: LessonContent = {
  ...
  dialogue: {
    ...
    },
    {
      ...
      examples: [
        {
          fill: '办理入住',
          fillPinyin: 'bàn lǐ rù zhù',
          hanzi: '我要办理入住。',
          pinyin: 'wǒ yào bàn lǐ rù zhù.',
          en: 'I want to check in.',
          fr: 'Je veux m’enregistrer.',
          audio: '/audio/order-food/pattern-06-example-01.mp3',
        },
        {
          fill: '一张房卡',
          fillPinyin: 'yì zhāng fáng kǎ',
          hanzi: '我要一张房卡。',
          pinyin: 'wǒ yào yì zhāng fáng kǎ.',
          en: 'I want a room key card.',
          fr: 'Je veux une carte d’accès à ma chambre.',
          audio: '/audio/order-food/pattern-06-example-02.mp3',
        },
        {
          fill: '退房',
          fillPinyin: 'tuì fáng',
          hanzi: '我要退房。',
          pinyin: 'wǒ yào tuì fáng.',
          en: 'I want to check out.',
          fr: 'Je veux quitter la chambre.',
          audio: '/audio/order-food/pattern-06-example-03.mp3',
        },
      ],
    },
    {
      ...
      examples: [
        {
          fill: '预订房间了',
          fillPinyin: 'yù dìng fáng jiān le',
          hanzi: '我已经预订房间了。',
          pinyin: 'wǒ yǐ jīng yù dìng fáng jiān le.',
          en: 'I have already booked a room.',
          fr: 'J’ai déjà réservé une chambre.',
          audio: '/audio/order-food/pattern-08-example-01.mp3',
        },
        {
          fill: '付钱了',
          fillPinyin: 'fù qián le',
          hanzi: '我已经付钱了。',
          pinyin: 'wǒ yǐ jīng fù qián le.',
          en: 'I have already paid.',
          fr: 'J’ai déjà payé.',
          audio: '/audio/order-food/pattern-08-example-02.mp3',
        },
        {
          fill: '入住了',
          fillPinyin: 'rù zhù le',
          hanzi: '我已经入住了。',
          pinyin: 'wǒ yǐ jīng rù zhù le.',
          en: 'I have already checked in.',
          fr: 'Je me suis déjà enregistré(e).',
          audio: '/audio/order-food/pattern-08-example-03.mp3',
        },
      ],
    },
    {
      ...
      examples: [
        {
          fill: '晚一点退房',
          fillPinyin: 'wǎn yì diǎn tuì fáng',
          hanzi: '我可以晚一点退房吗？',
          pinyin: 'wǒ kě yǐ wǎn yì diǎn tuì fáng ma?',
          en: 'Can I check out later?',
          fr: 'Puis-je partir plus tard ?',
          audio: '/audio/order-food/pattern-12-example-01.mp3',
        },
        {
          fill: '先看一下房间',
          fillPinyin: 'xiān kàn yí xià fáng jiān',
          hanzi: '我可以先看一下房间吗？',
          pinyin: 'wǒ kě yǐ xiān kàn yí xià fáng jiān ma?',
          en: 'Can I see the room first?',
          fr: 'Puis-je voir la chambre d’abord ?',
          audio: '/audio/order-food/pattern-12-example-02.mp3',
        },
        {
          fill: '换一个房间',
          fillPinyin: 'huàn yí gè fáng jiān',
          hanzi: '我可以换一个房间吗？',
          pinyin: 'wǒ kě yǐ huàn yí gè fáng jiān ma?',
          en: 'Can I change rooms?',
          fr: 'Puis-je changer de chambre ?',
          audio: '/audio/order-food/pattern-12-example-03.mp3',
        },
      ],
    }
    ],
  vocabulary: [
    ...
    {
      id: 'order-food-vocab-6', hanzi: 'WiFi密码', pinyin: 'Wi-Fi mì mǎ', audio: '/audio/order-food/vocab-06.mp3',
