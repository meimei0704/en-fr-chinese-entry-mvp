  ...
  sentencePatterns: [
    {
      ...
      pattern: '我要办理入住。',
      meaning: { en: 'Hello, I want to check in.', fr: 'Bonjour, je veux faire le check-in.' },
      example: '您好，我要办理入住。',
    ...
    },
    {
      ...
      pattern: '你会说英文吗？',
      meaning: { en: 'Do you speak English?', fr: 'Parlez-vous anglais ?' },
      example: '你会说英文吗？',
    ...
    },
    {
      ...
      pattern: '这是我的……。',
      meaning: { en: 'Here is my ...', fr: 'Voici mon / ma ...' },
      example: '这是我的护照。',
    ...
    },
    {
      ...
      pattern: '几点……？',
      meaning: { en: 'What time is breakfast?', fr: 'À quelle heure est le petit-déjeuner ?' },
      example: '几点吃早餐？',
    ...
    },
    {
      ...
      pattern: '……在哪里？',
      meaning: { en: 'Where is the elevator?', fr: 'Où est l\'ascenseur ?' },
      example: '电梯在哪里？',
    ...
    },
    {
      ...
      pattern: '请……。',
      meaning: { en: 'Please clean my room.', fr: 'Veuillez nettoyer ma chambre.' },
      example: '请打扫房间。',
