  ...
  sentencePatterns: [
    {
      ...
      explanation: {
        en: 'Use this to open a polite help request in a public place.',
        fr: 'Utilise cette structure pour ouvrir une demande d’aide polie dans un lieu public.',
      },
    },
    {
      ...
      explanation: {
        en: 'Name the lost item after 丢了, like your passport.',
        fr: 'Nomme l\'objet perdu après 丢了, comme ton passeport.',
      },
    },
    {
      ...
      explanation: {
        en: 'Ask 请说慢一点 when the other person speaks too fast.',
        fr: 'Demande 请说慢一点 quand l\'autre personne parle trop vite.',
      },
    },
    {
      id: 'ask-for-help-problem-pattern-4',
      pattern: '我听不懂。',
      meaning: { en: 'I don\'t understand.', fr: 'Je ne comprends pas.' },
      example: '我听不懂。',
      audio: '/audio/ask-for-help-problem/pattern-04.mp3',
      explanation: {
        en: 'Say 我听不懂 to let the helper know you need simpler words.',
        fr: 'Dis 我听不懂 pour indiquer à la personne que tu as besoin de mots plus simples.',
      },
    },
    {
      id: 'ask-for-help-problem-pattern-5',
      pattern: '我迷路了。',
      meaning: { en: 'I am lost.', fr: 'Je suis perdu(e).' },
      example: '我迷路了。',
      audio: '/audio/ask-for-help-problem/pattern-05.mp3',
      explanation: {
        en: 'Say 我迷路了 when you cannot find your way.',
