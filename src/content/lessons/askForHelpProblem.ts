  ...
  sentencePatterns: [
    {
      ...
      pattern: '你可以帮我吗？',
      meaning: { en: 'Excuse me, can you help me?', fr: 'Pouvez-vous m’aider ?' },
      example: '请问，你可以帮我吗？',
    ...
    },
    {
      ...
      pattern: '我的……丢了。',
      meaning: { en: 'I lost my ...', fr: 'J\'ai perdu ...' },
      example: '我护照丢了。',
    ...
    },
    {
      ...
      pattern: '请说慢一点。',
      meaning: { en: 'Please speak slower.', fr: 'Parlez plus lentement, s\'il vous plaît.' },
      example: '请说慢一点。',
    ...
    },
    {
      ...
      pattern: '……在哪里？',
      meaning: { en: 'Where is the toilet?', fr: 'Où sont les toilettes ?' },
      example: '卫生间在哪里？',
    ...
    },
    {
      ...
      pattern: '我……不见了。',
      meaning: { en: 'I lost my phone.', fr: 'J\'ai perdu mon téléphone.' },
      example: '我的手机不见了。',
    ...
    },
    {
      ...
      pattern: '请给……打电话。',
      meaning: { en: 'Please call the police.', fr: 'Veuillez appeler la police.' },
      example: '请给警察打电话。',
