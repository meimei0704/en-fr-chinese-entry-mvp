...
export const smallTalkLesson: LessonContent = {
  ...
  scenario: {
    en: 'Start and keep a friendly conversation: ask where someone is from, talk about the weather, food, and plans.',
    fr: 'Engager et poursuivre une conversation amicale : demander d’où vient quelqu’un, parler de la météo, de la nourriture et des projets.',
  },
  dialogue: {
    title: {
      en: 'A friendly chat',
  ...
  sentencePatterns: [
    {
      ...
      explanation: {
        en: 'The standard way to ask where someone comes from.',
        fr: 'La façon standard de demander d’où vient quelqu’un.',
      },
    },
    {
      ...
      explanation: {
        en: 'Swap in a nationality or city to say where you are from.',
        fr: 'Remplacez par une nationalité ou une ville pour dire d’où vous venez.',
      },
    },
    {
      ...
      explanation: {
        en: 'Use 怎么样 to ask how something is, like the weather.',
        fr: 'Utilisez 怎么样 pour demander comment est quelque chose, comme le temps.',
      },
    },
    {
      ...
      explanation: {
        en: '我打算 states what you plan to do.',
        fr: '我打算 indique ce que vous comptez faire.',
      },
    },
    {
      ...
      pattern: '很高兴和你……',
      meaning: {
        en: 'It was nice to ... with you.',
        fr: 'J’ai été ravi de ... avec vous.',
      },
      example: '很高兴和你聊天。',
      audio: '/audio/small-talk/pattern-05.mp3',
      explanation: {
        en: 'Use 和你 before a verb like 聊天 to talk about doing something together.',
        fr: 'Utilisez 和你 avant un verbe comme 聊天 pour parler d’une activité partagée.',
      },
    },
  ],
  vocabulary: [
