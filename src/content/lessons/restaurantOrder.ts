  ...
  sentencePatterns: [
    {
      ...
      explanation: {
        en: 'Ask for the menu first with 请给我菜单.',
        fr: 'Demande d\'abord le menu avec 请给我菜单.',
      },
    },
    {
      ...
      explanation: {
        en: 'Order noodles or rice by bowl with 我要一碗.',
        fr: 'Commande des nouilles ou du riz en bol avec 我要一碗.',
      },
    },
    {
      ...
      explanation: {
        en: '不要辣 is the clearest way to avoid spice in a dish.',
        fr: '不要辣 est la façon la plus claire d\'éviter le piment dans un plat.',
      },
    },
    {
      ...
      explanation: {
        en: 'Use 我对…过敏 to name an allergy before ordering.',
        fr: 'Utilise 我对…过敏 pour nommer une allergie avant de commander.',
      },
    },
    {
      id: 'restaurant-order-pattern-5',
      pattern: '可以打包带走吗？',
      meaning: { en: 'Could you pack it for takeaway?', fr: 'Pouvez-vous l\'emballer pour emporter ?' },
      example: '可以打包带走吗？',
      audio: '/audio/restaurant-order/pattern-05.mp3',
      explanation: {
        en: 'Ask this at the end of the meal if you want to take the food away.',
