  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        explanation: { en: '可以 = may/can｜点 = to order｜餐 = meal｜了 = (completed action particle)｜吗 = (question particle). Use it when you are ready to order.', fr: '可以 = pouvoir｜点 = commander｜餐 = repas｜了 = (particule d\'action accomplie)｜吗 = (particule interrogative). Utilisez-la lorsque vous êtes prêt à commander.' },
      ...
      },
      {
        ...
        explanation: { en: '我 = I｜吃 = to eat｜饱 = full｜了 = (completed action particle). Use it to let the server know you have eaten enough.', fr: '我 = je｜吃 = manger｜饱 = rassasié｜了 = (particule d\'action accomplie). Utilisez-la pour dire au serveur que vous avez assez mangé.' },
