  ...
  sentencePatterns: [
    {
      ...
      pattern: '请给我……。',
      meaning: { en: 'Could I have ... please?', fr: 'Puis-je avoir ... ?' },
      example: '请给我菜单。',
    ...
    },
    {
      ...
      pattern: '我要一碗……。',
      meaning: { en: 'A bowl of ..., please.', fr: 'Un bol de ..., s\'il vous plaît.' },
      example: '我要一碗面条。',
    ...
    },
    {
      ...
      pattern: '不要……。',
      meaning: { en: 'No ..., please.', fr: 'Sans ..., s\'il vous plaît.' },
      example: '不要辣。',
    ...
    },
    {
      ...
      pattern: '可以点餐了吗？',
      meaning: { en: 'Can I order now?', fr: 'Puis-je commander maintenant ?' },
      example: '可以点餐了吗？',
    ...
    },
    {
      ...
      pattern: '您好，结账。',
      meaning: { en: 'Hello, the check, please.', fr: 'Bonjour, l\'addition, s\'il vous plaît.' },
      example: '您好，结账。',
