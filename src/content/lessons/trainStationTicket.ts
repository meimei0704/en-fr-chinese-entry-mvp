...
export const trainStationTicketLesson: LessonContent = {
  ...
  pronunciation: [
    ...
    {
      id: 'train-station-ticket-pronunciation-2',
      focus: { en: 'sh vs x contrast: 上海 vs 西安', fr: 'Contraste sh vs x : 上海 vs 西安' },
      audioText: '上海，不是西安；硬座，三点出发',
      audio: '/audio/train-station-ticket/pronunciation-02.mp3',
      tip: {
        en: '上海 (Shànghǎi) has a retroflex sh-; 西安 (Xī\'ān) has a palatal x-. Keep the two distinct so you don\'t end up in the wrong city.',
        fr: '上海 (Shànghǎi) a un sh- rétroflexe ; 西安 (Xī\'ān) a un x- palatal. Garde les deux distincts pour ne pas te retrouver dans la mauvaise ville.',
      },
      explanation: {
        en: 'Mixing sh and x in a ticket office could send you to the wrong destination.',
        fr: 'Confondre sh et x au guichet pourrait t\'envoyer à la mauvaise destination.',
      },
    },
  ],
  hanziRecognition: [
    ...
    { id: 'train-station-ticket-hanzi-5', hanzi: '站', pinyin: 'zhàn', meaning: { en: 'station / stand', fr: 'gare / station / se tenir debout' }, explanation: { en: 'Recognize 站 in 站台 and 火车站 on station signs.', fr: 'Reconnais 站 dans 站台 et 火车站 sur les panneaux de gare.' } },
    { id: 'train-station-ticket-hanzi-6', hanzi: '台', pinyin: 'tái', meaning: { en: 'platform / stage', fr: 'plateforme / quai' }, explanation: { en: 'Recognize 台 in 站台 to find your boarding area.', fr: 'Reconnais 台 dans 站台 pour trouver ta zone d\'embarquement.' } },
  ],
  practice: {
    listening: [
      {
