...
export const trainStationTicketLesson: LessonContent = {
  ...
  vocabulary: [
    ...
    { id: 'train-station-ticket-vocab-6', hanzi: '硬座', pinyin: 'yìng zuò', audio: '/audio/train-station-ticket/vocab-06.mp3', meaning: { en: 'hard seat (basic class)', fr: 'place dure (classe de base)' }, explanation: { en: 'The most common and affordable train seat type.', fr: 'Le type de place le plus courant et abordable en train.' } },
    { id: 'train-station-ticket-vocab-7', hanzi: '软座', pinyin: 'ruǎn zuò', audio: '/audio/train-station-ticket/vocab-07.mp3', meaning: { en: 'soft seat (comfort class)', fr: 'place molle (classe confort)' }, explanation: { en: 'A more comfortable seat option that costs a bit more.', fr: 'Une option de place plus confortable qui coûte un peu plus cher.' } },
    ...
    { id: 'train-station-ticket-vocab-11', hanzi: '进站口', pinyin: 'jìn zhàn kǒu', audio: '/audio/train-station-ticket/vocab-11.mp3', meaning: { en: 'entrance', fr: 'entrée' }, explanation: { en: 'The entrance you use to go into the station.', fr: 'L\'entrée que tu utilises pour entrer dans la gare.' } },
    { id: 'train-station-ticket-vocab-12', hanzi: '人工通道', pinyin: 'rén gōng tōng dào', audio: '/audio/train-station-ticket/vocab-12.mp3', meaning: { en: 'manual lane', fr: 'voie manuelle' }, explanation: { en: 'Use this if automated gates do not read your passport.', fr: 'Utilise cette voie si les portiques automatiques ne lisent pas ton passeport.' } },
