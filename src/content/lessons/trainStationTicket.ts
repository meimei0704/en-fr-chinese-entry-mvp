  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        explanation: { en: '我 = I｜要 = want / would like｜一张 = one ticket｜去 = to｜北京 = Beijing｜的票 = ticket. Replace 北京 with your destination when buying a ticket.', fr: '我 = je｜要 = vouloir｜一张 = un billet｜去 = pour / vers｜北京 = Pékin｜的票 = billet. Remplacez 北京 par votre destination lors de l’achat.' },
      ...
      },
      {
        ...
        translation: { en: 'How can I cancel my ticket and get a refund?', fr: 'Comment obtenir l\'annulation et le remboursement du billet ?' },
