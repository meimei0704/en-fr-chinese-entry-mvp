  ...
  dialogue: {
    ...
    },
    {
      ...
      examples: [
        {
          fill: '我的车',
          fillPinyin: 'wǒ de chē',
          hanzi: '我的车晚点了吗？',
          pinyin: 'wǒ de chē wǎn diǎn le ma?',
          en: 'Is my train delayed?',
          fr: 'Mon train est-il en retard ?',
        ...
        },
        {
          ...
          fillPinyin: 'fēi jī',
          hanzi: '飞机晚点了吗？',
          pinyin: 'fēi jī wǎn diǎn le ma?',
          en: 'Is the plane delayed?',
          fr: 'L’avion est-il en retard ?',
          audio: '/audio/train-station-ticket/pattern-04-example-03.mp3',
        },
      ],
    }
    ],
