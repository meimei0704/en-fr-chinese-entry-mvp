...
export const trainStationTicketLesson: LessonContent = {
  ...
  sentencePatterns: [
    ...
    },
    {
      ...
      pattern: '我要一张去……的票。',
      meaning: { en: 'I want to buy one ticket to ...', fr: 'Je veux acheter un billet pour ...' },
      example: '我要一张去[北京]的票。',
    ...
    },
    {
      ...
      pattern: '……几点开？',
      meaning: { en: 'What time does ... leave?', fr: 'À quelle heure part ... ?' },
      example: '火车几点开？',
