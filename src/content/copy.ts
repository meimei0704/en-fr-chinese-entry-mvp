...
export const uiCopy = {
  ...
  fr: {
    ...
    practiceChallenge: {
      ...
      recordStop: 'Arrêter',
      recordReplay: 'Écouter',
      recordUnsupported: 'L’enregistrement n’est pas pris en charge par ce navigateur.',
      recordDenied: 'Accès au microphone refusé. L’enregistrement est indisponible.',
      recordError: 'L’enregistrement n’a pas pu démarrer. Réessayez.',
