...
describe('course content', () => {
  it('exposes twelve lessons in canonical journey order with static audio paths', async () => {
    ...
    const expandedCounts: Record<string, Record<string, number>> = {
      ...
      'ask-directions': { dialogue: 8, patterns: 11, vocab: 10, practice: 2, cards: 6 },
      'order-food': { dialogue: 8, patterns: 13, vocab: 10, practice: 2, cards: 6 },
      'phone-and-payment': { dialogue: 8, patterns: 9, vocab: 10, practice: 2, cards: 6 },
      'restaurant-order': { dialogue: 8, patterns: 14, vocab: 10, practice: 2, cards: 6 },
      'train-station-ticket': { dialogue: 8, patterns: 12, vocab: 15, practice: 2, cards: 6 },
      'metro-ticket': { dialogue: 8, patterns: 9, vocab: 14, practice: 2, cards: 6 },
      'convenience-store-run': { dialogue: 8, patterns: 12, vocab: 10, practice: 2, cards: 6 },
      'ask-for-help-problem': { dialogue: 8, patterns: 16, vocab: 10, practice: 2, cards: 6 },
      'pharmacy-help': { dialogue: 8, patterns: 13, vocab: 11, practice: 2, cards: 6 },
      'small-talk': { dialogue: 8, patterns: 11, vocab: 10, practice: 2, cards: 6 },
    }
  ...
  it('ships non-empty MP3 audio files for every Chinese playback reference', async () => {
    ...
    expect(audioPaths).toHaveLength(439)
