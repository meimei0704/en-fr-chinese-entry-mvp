  ...
  reference: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: 'iu',
          pinyin: 'qiú',
          description: { en: 'Glide from "ee" to "oh", like "yo". Ball = 球.', fr: 'Glissez de « i » vers « o », comme « io ». Balle = 球.', },
        ...
        },
        {
          ...
          label: 'er',
          pinyin: 'ěr',
          description: { en: 'A rhotic "er" — curl the tongue tip. Ear = 耳.', fr: 'Un « er » rhotique — recourbez la pointe de la langue. Oreille = 耳.', },
