...
export const pinyinLesson3: PinyinLessonContent = {
  ...
  shadowing: {
    title: {
      en: 'Shadow compound-finals phrases',
      fr: 'Répéter des phrases à finales composées',
    },
    instructions: {
      en: 'Play each prompt, pause, and repeat — pay attention to nasal endings.',
      fr: 'Lancez chaque phrase, faites pause, puis répétez — faites attention aux terminaisons nasales.',
    },
    prompts: [
      {
        id: 'shadow-bei-jing',
        promptText: '北京',
        pinyin: 'Běi jīng',
        meaning: { en: 'Beijing.', fr: 'Pékin.', },
        audio: `${lessonAudioBase}/shadow-bei-jing.mp3`,
      },
      {
        id: 'shadow-xiang-gang',
        promptText: '香港',
        pinyin: 'Xiāng gǎng',
        meaning: { en: 'Hong Kong.', fr: 'Hong Kong.', },
        audio: `${lessonAudioBase}/shadow-xiang-gang.mp3`,
      },
      {
        id: 'shadow-can-ting',
        promptText: '餐厅',
        pinyin: 'cān tīng',
        meaning: { en: 'Restaurant.', fr: 'Restaurant.', },
        audio: `${lessonAudioBase}/shadow-can-ting.mp3`,
      },
      {
        id: 'shadow-xue-xi',
        promptText: '学习',
        pinyin: 'xué xí',
        meaning: { en: 'To study.', fr: 'Étudier.', },
        audio: `${lessonAudioBase}/shadow-xue-xi.mp3`,
      },
      {
        id: 'shadow-fang-bian',
        promptText: '方便',
        pinyin: 'fāng biàn',
        meaning: { en: 'Convenient.', fr: 'Pratique.', },
        audio: `${lessonAudioBase}/shadow-fang-bian.mp3`,
      },
    ],
  },
}
