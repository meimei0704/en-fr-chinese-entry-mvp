...
export const pinyinLesson2: PinyinLessonContent = {
  ...
  shadowing: {
    title: {
      en: 'Shadow sibilant phrases',
      fr: 'Répéter des phrases sibilantes',
    },
    instructions: {
      en: 'Play each prompt, pause, and repeat — focus on crisp sibilant sounds.',
      fr: 'Lancez chaque phrase, faites pause, puis répétez — concentrez-vous sur les sons sibilants.',
    },
    prompts: [
      {
        id: 'shadow-zhi-dao',
        ...
        audio: `${lessonAudioBase}/shadow-zhi-dao.mp3`,
      },
      {
        id: 'shadow-chi-fan',
        promptText: '吃饭',
        ...
        audio: `${lessonAudioBase}/shadow-chi-fan.mp3`,
      },
      {
        id: 'shadow-si-chuan',
        promptText: '四川',
        ...
        audio: `${lessonAudioBase}/shadow-si-chuan.mp3`,
      },
      {
        id: 'shadow-ji-qi',
        promptText: '机器',
        ...
        audio: `${lessonAudioBase}/shadow-ji-qi.mp3`,
      },
      {
        id: 'shadow-jian-shi',
        promptText: '见识',
        pinyin: 'jiàn shì',
        meaning: {
          en: 'Experience / insight.',
          fr: 'Expérience / aperçu.',
        },
        audio: `${lessonAudioBase}/shadow-jian-shi.mp3`,
      },
    ],
  },
}
